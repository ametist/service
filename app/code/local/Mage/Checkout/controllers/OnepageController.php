...
//            $data = $this->_filterPostData($postData);
    ...
    {      
        try{            
            ...
            $billingAddress['firstname'] = Mage::getSingleton('customer/session')->getCustomer()->getFirstname();
            $billingAddress['lastname'] = Mage::getSingleton('customer/session')->getCustomer()->getLastname();
