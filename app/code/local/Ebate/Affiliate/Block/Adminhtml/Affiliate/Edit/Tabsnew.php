<?php
    ...
    class Ebate_Affiliate_Block_Adminhtml_Affiliate_Edit_Tabsnew extends Mage_Adminhtml_Block_Widget_Tabs
    {
        ...
        protected function _beforeToHtml()
        {
            ...
            $this->addTab('form_section2', array(
                ...
                'content'   => $this->getLayout()->createBlock('affiliate/adminhtml_affiliate_edit_tab_formnew')->toHtml(),
            ));
