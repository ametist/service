...
//        die(var_export($creditmemo->getData()));
        if ($creditmemo->getCustomerBalanceTotalRefunded() > $creditmemo->getBaseCustomerBalanceReturnMax()) {//Was $creditmemo->getCustomerBalanceReturnMax() but its return 0.00
